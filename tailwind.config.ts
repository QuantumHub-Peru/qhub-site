    ...
    extend: {
      ...
      colors: {
        ...
        quantum: {
          ...
          turquoise: "hsl(var(--quantum-turquoise))",
          dark: "hsl(var(--quantum-dark))",
          "dark-lighter": "hsl(var(--quantum-dark-lighter))",
        },
        dept: {
          research: "hsl(var(--dept-research))",
          academic: "hsl(var(--dept-academic))",
          innovation: "hsl(var(--dept-innovation))",
          relations: "hsl(var(--dept-relations))",
          community: "hsl(var(--dept-community))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
